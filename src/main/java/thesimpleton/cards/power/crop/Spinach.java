...
public class Spinach extends AbstractCropPowerCard {
  public static final String ID = "TheSimpletonMod:Spinach";
  public static final String NAME;
  public static final String DESCRIPTION;
  public static final String IMG_PATH = "cards/spinach.png";
  ...
  public void use(AbstractPlayer p, AbstractMonster m) {
    AbstractDungeon.actionManager.addToBottom(
        new ApplyCropAction(p, p, new PlantSpinachPower(p, this.magicNumber), this.magicNumber, true));
  }

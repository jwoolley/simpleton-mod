...
public class CircleOfAmplification extends AbstractCircle {
    public static final String ID = "TheSimpletonMod:CircleOfAmplification";
    ...
    public CircleOfAmplification() {
        super(ID, NAME, TheSimpletonMod.getResourcePath(IMG_PATH), DESCRIPTION, EXTENDED_DESCRIPTION[0], RARITY, TARGET);

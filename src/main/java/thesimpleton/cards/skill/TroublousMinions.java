...
public class TroublousMinions extends CustomCard {
    public static final String ID = "TheSimpletonMod:TroublousMinions";
    public static final String NAME;
    public static final String DESCRIPTION;
    public static final String IMG_PATH = "cards/troublousminions.png";

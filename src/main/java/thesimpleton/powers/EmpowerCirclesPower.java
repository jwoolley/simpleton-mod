...
public class EmpowerCirclesPower extends AbstractTheSimpletonPower implements OnCardDrawPower {
    public static final String POWER_ID = "TheSimpletonMod:EmpowerCirclesPower";
    ...
    public void onCardDraw(AbstractCard c) {
        if (c.hasTag(TheSimpletonCardTags.CIRCLE)) {
            this.flash();

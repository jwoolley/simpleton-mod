...
public class SpitefulPlanPower extends AbstractTheSimpletonPower implements OnCardDrawPower {
    public static final String POWER_ID = "TheSimpletonMod:SpitefulPlanPower";

...
public class DemonicPactPower extends AbstractTheSimpletonPower {
    public static final String POWER_ID = "TheSimpletonMod:DemonicPactPower";
    ...
    public void onUseCard(AbstractCard card, UseCardAction action) {
        if (card.hasTag(TheSimpletonCardTags.RITUAL)) {
            this.flash();

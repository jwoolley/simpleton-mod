...
public class HellfireBreathingPower extends AbstractTheSimpletonPower implements OnCardDrawPower {
    public static final String POWER_ID = "TheSimpletonMod:HellfireBreathingPower";

...
public class LuckyCharmPower extends AbstractTheSimpletonPower implements OnCardDrawPower {
    public static final String POWER_ID = "TheSimpletonMod:LuckyCharmPower";

...
public class VoidFormPower extends AbstractTheSimpletonPower implements OnCardDrawPower {
    public static final String POWER_ID = "TheSimpletonMod:VoidFormPower";
